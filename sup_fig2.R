...
HeLa = readRDS(file = "results/plots/hsa_PRJNA512378_miR-16-5p_HeLa_alt_utr_old_no_filt.rds")
A549 = readRDS(file = "results/plots/hsa_PRJNA304643_miR-1343-3p_A549_alt_utr_old_no_filt.rds")
...
NMuMG = readRDS(file='results/plots/mmu_PRJNA340017_miR-1199-5p_NMuMG_alt_utr_old_no_filt.rds')
ESCs = readRDS(file='results/plots/mmu_PRJNA270999_miR-294-3p_ESCs_alt_utr_old_no_filt.rds')
...
ggsave('results/plots/sup_fig2.png',plot = g, scale=1.25)
