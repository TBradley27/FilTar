...
awk '{ OFS="\t" }{print $1,$2-1,$3,$4,$5,$6}'   > results/bed/"$species"_"$path_var_two".chr"$chromosome".bed
...
#    tr ' '  \\t    |
    #awk '$2!=$3' | # the next line converts from 1 to 0-based indexing
#    awk '{ OFS="\t" }{print $1,$2-1,$3,$4,$5,$6}'  > results/bed/"$species"_"$path_var_two"_chr"$chromosome".bed
#
#    if [[ "$?" -ne 0 ]]; then
