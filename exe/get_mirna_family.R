...
mirna_seeds = read_table2(commandline_args[1], col_names=c("identifier", "seq"))
...
write.table(mirna_seeds, commandline_args[2], sep="\t", quote=FALSE, col.names=FALSE, row.names=FALSE)
